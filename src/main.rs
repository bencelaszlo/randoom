...
fn main() -> std::io::Result<()> {
    ...
    println!("\n\t\t{}{}{}{}{}{}{}\n", "r".red().blink().underline().bold(), "a".yellow().blink().underline().bold(), "n".white().blink().underline().bold(), "d".cyan().blink().underline().bold(), "o".blue().blink().underline().bold(), "o".green().blink().underline().bold(), "m".magenta().blink().underline().bold() );
    ...
    println!("{}", "Generate random data with the following parameters:".cyan() );
    ...
    println!("{}", "Generate data and write generated data into file...".magenta() );
    ...
    if option_datatype == "f32" {
        for i in 0..option_number {
            ...
            print!("\r--> {} / {}", (i + 1).to_string().cyan(), option_number.to_string().blue() );
...
//            let blue_component: String = format!("{:x}", rng.gen_range(0, 255) );
            ...
            let generated_data = "#".to_string() + &red_component.to_string() + &green_component.to_string() + &blue_component.to_string();
            print!("\r--> {} / {}", (i + 1).to_string().cyan(), option_number.to_string().blue() );
            write!(buffer, "{}{}", generated_data, option_separator).unwrap();
        }
    }

    println!("\n-----> {} {}", option_number.to_string().green().bold(), " data generated and wrote into file successfully.".green() );
